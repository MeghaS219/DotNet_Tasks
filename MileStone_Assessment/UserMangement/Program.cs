...
namespace UserMangement
{
    ...
    {
        private const string ConnectionString = "Server=WIPDNFSD;Database=SampleDB;User Id=Ustdotcsharp10;Password=Yuy3wiPo;";
        ...
        public static void UpdateData(int id, string name, string email, SqlConnection con)
        {
            try
            {
                ...
                int affectedRowCount = cmd.ExecuteNonQuery(); // Get affected row Count
